...
export const TEMPLATE_A4: TemplateDefinition = {
  ...
  layout: [
    ...
    ...itemList('INVENTORY', 110, { maxItems: 20, fontSize: 8 }),
    ...footer('Generated by Sheet Magnet', 297),
  ],
};
...
export const TEMPLATE_A5: TemplateDefinition = {
  ...
  layout: [
    ...
    ...itemList('ITEMS', 50, { maxItems: 15, width: 128 }),
    ...footer('Sheet Magnet', 210, 148),
  ],
};
...
export const TEMPLATE_A6: TemplateDefinition = {
  ...
  layout: [
    ...
    ...itemList('ITEMS', 45, { maxItems: 10, width: 85 }),
    ...footer('Sheet Magnet', 148, 105),
  ],
};
...
export const TEMPLATE_A3: TemplateDefinition = {
  ...
  layout: [
    ...
    ...itemList('ITEMS', 70, { maxItems: 40, width: 277 }),
    ...footer('Generated by Sheet Magnet', 420, 297),
  ],
};
